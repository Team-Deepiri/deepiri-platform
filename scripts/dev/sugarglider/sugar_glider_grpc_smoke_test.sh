...
usage() {
    cat <<'EOF'
Usage: sugar_glider_grpc_smoke_test.sh [options]

Options:
  --addr <host:port>           Sugar Glider gRPC address (default: localhost:50051)
  --stream <name>              Redis stream name (default: platform-events)
  --group <name>               Consumer group name (default: sugar-glider-grpc-smoke)
