        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Trailblip</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              AI-powered micro-adventures that turn your free time into unforgettable experiences. 
              Discover your city in new and exciting ways.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Trailblip. All rights reserved.
            </p>
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <span className="text-gray-400 text-sm">Made with ❤️ for adventurers</span>
            </div>
          </div>
        </div>
      </div>
