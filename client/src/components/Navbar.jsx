            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  ...
                  {/* Dropdown Menu */}
                  <motion.div 
                    className="absolute right-0 mt-2 w-56 glass rounded-2xl border border-white/20 overflow-hidden"
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              animate="visible"
              exit="hidden"
              className="lg:hidden glass rounded-2xl mt-4 mb-4 overflow-hidden"
            >
              <div className="py-4">
                {isAuthenticated ? (
                  <>
