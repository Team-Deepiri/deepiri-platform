...
def run_docker_compose():
    ...
    # Run docker-compose
    compose_file = project_root / 'docker-compose.platform-engineers.yml'
    ...
    try:
        ...
        print()
        print(f"{GREEN}✅ Platform Engineers Environment Started!{RESET}")
        print()
        ...
        print("  docker compose -f docker-compose.platform-engineers.yml logs -f")
        print()
