...
def run_docker_compose():
    ...
    # Run docker-compose
    compose_file = project_root / 'docker-compose.infrastructure-team.yml'
    ...
    try:
        ...
        print("  - Redis:           redis://localhost:6380")
        print("  - InfluxDB:        http://localhost:8086")
        print()
        print(f"{GRAY}View logs:{RESET}")
        print("  docker compose -f docker-compose.infrastructure-team.yml logs -f")
        print()
