...
def main():
    ...
    services = [
        ...
        {
            "image": None,
            "name": "deepiri-gamification-service",
            "build": {
        ...
        {
            "image": None,
            "name": "deepiri-analytics-service",
            "build": {
        ...
        {
            "image": None,
            "name": "deepiri-integration-service",
            "build": {
        ...
        {
            "image": None,
            "name": "deepiri-websocket-service",
            "build": {
