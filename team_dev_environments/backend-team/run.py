...
def main():
    ...
    print(f"  - Workflow Orchestrator: http://localhost:{get_port('workflow-orchestrator', 'backend')}")
    print(f"  - Incentive Engine: http://localhost:{get_port('incentive-engine', 'backend')}")
    print(f"  - Decision Intelligence: http://localhost:{get_port('decision-intelligence', 'backend')}")
    print(f"  - Communications Hub: http://localhost:{get_port('communications-hub', 'backend')}")
    print(f"  - External Bridge: http://localhost:{get_port('external-bridge-service', 'backend')}")
    print(f"  - Adaptive Experience Engine: http://localhost:{get_port('adaptive-experience-engine', 'backend')}")
