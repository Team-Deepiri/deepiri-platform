...
def main():
    ...
    print(f"  - Truss: http://localhost:{get_port('truss', 'backend')}")
    print(f"  - Registry: http://localhost:{get_port('registry', 'backend')}")
    print(f"  - Telemetry: http://localhost:{get_port('telemetry', 'backend')}")
    print(f"  - External Bridge: http://localhost:{get_port('external-bridge-service', 'backend')}")
    print(f"  - Jobs: http://localhost:{get_port('jobs', 'backend')}")
