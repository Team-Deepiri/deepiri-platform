#!/bin/bash
# Backend Team - Update Submodules Script
# This script updates all submodules required by the Backend Team to their latest versions

set -e

echo "⚙️  Backend Team - Updating Submodules"
echo "======================================"
echo ""
