...
echo "🔧 Setting up Git hooks for Infrastructure Team..."
echo ""
...
# Infrastructure Team submodules (all except frontend)
echo "🔄 Syncing hooks to Infrastructure Team submodules..."
echo ""
...
echo ""
echo "✅ Infrastructure Team hooks setup complete!"
echo ""
