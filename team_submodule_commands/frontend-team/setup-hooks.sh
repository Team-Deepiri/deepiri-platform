...
echo "🔧 Setting up Git hooks for Frontend Team..."
echo ""
...
echo "🔄 Syncing hooks to Frontend Team submodules..."
echo ""

# List of Frontend Team submodules
SUBMODULES=(
...
echo ""
echo "✅ Frontend Team hooks setup complete!"
echo ""
