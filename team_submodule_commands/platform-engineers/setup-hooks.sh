...
echo "🔧 Setting up Git hooks for Platform Engineers..."
echo ""
...
# Platform Engineers need ALL submodules
echo "🔄 Syncing hooks to ALL submodules (Platform Engineers manage everything)..."
echo ""
...
if [ -f ".gitmodules" ]; then
    while IFS= read -r submodule_path; do
        ...
        sync_hooks_to_submodule "$submodule_path"
...
echo ""
echo "✅ Platform Engineers hooks setup complete!"
echo ""
